...
public class AggregateRepository<T extends CommandProcessingAggregate<T, CT>, CT extends Command> {
  ...
  private Optional<UpdateOptions> withPossibleSnapshot(Optional<UpdateOptions> updateOptions, T aggregate, long snapshotVersion, List<EventWithMetadata> oldEvents, List<Event> newEvents) {
